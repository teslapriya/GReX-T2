...
def dump_cluster_results_jason(tab, clsnr, outputfile, output_cols=['mjds', 'snr', 'ibox', 'dm', 'ibeam']):
    """   
...
def dump_cluster_results_heimdall_format(tab, clsnr, outputfile_heimdall_columns): 
    """   
    Takes tab from parse_candsfile and clsnr from get_peak, 
