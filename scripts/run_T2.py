...
def main(argv):
    ...
    parser.add_argument('ip', type=str, default='10.41.0.126', help='ip address of heimdall')
    parser.add_argument('ports', type=str, default='12345,12346,12347,12348', help='ports address of heimdall (comma-delimited list)')
