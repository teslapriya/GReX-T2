...
max_point_size = 5.0
plt.scatter(
    (tab["mjds"] - tab["mjds"].min()) * 86400.0,
    tab["dm"],
    s=(max_point_size * tab["snr"] / tab["snr"].mean()),
    alpha=0.5,
)
plt.scatter(
    (tab2["mjds"] - tab2["mjds"].min()) * 86400.0,
    tab2["dm"],
    s=3.5,
)
plt.scatter(
    (tabdumb["mjds"] - tabdumb["mjds"].min()) * 86400.0,
    tabdumb["dm"],
    s=3.5,
)
plt.scatter((tab3["mjds"] - tab3["mjds"].min()) * 86400.0, tab3["dm"], s=3.5, c="k")
