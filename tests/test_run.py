...
def test_cluster_and_plot():
    ...
    lastname = socket_grex.cluster_and_plot(tab, 0)
...
def test_lastname():
    ...
    lastname = socket_grex.cluster_and_plot(
        tab, 0, outroot="tests/test_", max_ncl=100000
    )
    lastname2 = socket_grex.cluster_and_plot(
        tab, 0, outroot="tests/test_", max_ncl=100000, lastname=lastname
    )
